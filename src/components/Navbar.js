...
const Navbar = ({ children }) => {
    const navlink = <>
        ...
        <li className='dropdown dropdown-end dropdown-hover '>
            <label tabindex="0" class="btn btn-outline rounded-lg btn-primary">Book Now</label>
            <ul tabindex="0" class="dropdown-content  menu p-2 shadow bg-base-100 rounded-box w-52">
                <li><a>Item 1</a></li>
                <li><a>Item 2</a></li>
            </ul>
        </li>
        <li><label class="swap swap-rotate className='rounded-lg'">
            <input data-toggle-theme="dark,light" className='rounded-lg' type="checkbox" />
